...
export function TodoList({
  ...
  const activeTodos = useMemo(
    () => filteredTodos.filter((todo) => !todo.is_completed),
    [filteredTodos],
  );
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      {!hideForm && (
        <TodoForm defaultDate={defaultDate} defaultPriority={defaultPriority} />
      )}
