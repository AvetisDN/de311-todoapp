        ...
        {editingDescription ? (
          <textarea
            ...
            onKeyDown={(e) => {
              ...
              if (e.key === "Enter" && e.ctrlKey)
                handleSaveDescription(e.currentTarget.value);
            }}
          ...
          <>
            {todo.description && (
              <p
                onDoubleClick={() =>
                  !todo.is_completed && setEditingDescription(true)
                }
                className={cn(
            ...
            {!todo.description && !todo.is_completed && (
              ...
              >
                {language === "ru-RU"
                  ? "Двойной клик для добавления описания..."
        ...
        <div className="flex flex-wrap items-center gap-2 pt-1">
          {editingPriority ? (
            ...
            <Badge
              ...
              title={
                language === "ru-RU"
                  ? "Нажмите, чтобы изменить приоритет"
          ...
          {!todo.due_date && !todo.is_completed && (
            ...
            >
              ...
              {language === "ru-RU" ? "Добавить дату" : "Add date"}
            </Button>
          )}
          ...
          {editingCategory ? (
            ...
            todo.category && (
              <Badge
                ...
                title={
                  language === "ru-RU"
                    ? "Нажать, чтобы сменить категорию"
          ...
          {!todo.category && !todo.is_completed && categories.length > 0 && (
            ...
            >
              {language === "ru-RU" ? "Добавить метку" : "Add tag"}
            </Button>
          )}
        </div>
      </div>
